...
## unlimited
## Type: Int
c.completion.web_history_max_items = 5
...
['https://raw.githubusercontent.com/mikejakobsen/Qutebrowser/master/hosts',
        'https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/social/social-block', 'https://www.malwaredomainlist.com/hostslist/hosts.txt', 'http://someonewhocares.org/hosts/hosts', 'http://winhelp2002.mvps.org/hosts.zip', 'http://malwaredomains.lehigh.edu/files/justdomains.zip', 'https://pgl.yoyo.org/adservers/serverlist.php?hostformat=hosts&mimetype=plaintext']
...
c.content.user_stylesheets = ["~/.qutebrowser/stylesheets/duckduckgo.css"]
...
c.url.searchengines['s'] = 'https://searx.me/?q={}'
c.url.searchengines['a'] = 'https://wiki.archlinux.org/?search={}'
...
config.bind("<Shift-w>", 'set-cmd-text -s :session-save -o')

config.bind("<Ctrl-b>", 'set-cmd-text -s :open -t http://duckduckgo.com/bang?q=')

config.bind("<Alt-a>", 'open -t http://archlinux.org')
config.bind("<Alt-d>", 'open -t http://distrowatch.com')
config.bind("<Alt-g>", 'open -t http://github.com/mikejakobsen')
...
config.bind("<Alt-p>", 'open -t https://fantasy.premierleague.com')

config.bind("<Alt-f>", 'open -t https://www.mikejakobsen.org/cloud/')
config.bind("<Alt-m>", 'open -t https://www.mikejakobsen.org/cloud/index.php/apps/mail')
config.bind("<Alt-c>", 'open -t https://www.mikejakobsen.org/cloud/index.php/apps/calendar')
config.bind("<Alt-b>", 'open -t https://www.mikejakobsen.org/cloud/index.php/apps/bookmarks')
config.bind("<Alt-h>", 'open -t https://www.mikejakobsen.org/cloud/index.php/apps/notes')
config.bind("<Alt-t>", 'open -t https://www.mikejakobsen.org/cloud/index.php/apps/tasks')
config.bind("<Alt-n>", 'open -t https://www.mikejakobsen.org/cloud/index.php/apps/news')
...
config.bind("$", 'spawn -u qute-pass', mode='insert')
